...
function PlaySound()
{
	...
	if ( audioSourceTag != String.Empty && audioList.Length > 0 )    GameObject.FindGameObjectWithTag(audioSourceTag).GetComponent.<AudioSource>().PlayOneShot(audioList[Mathf.Floor(Random.value * audioList.Length)]);
}
